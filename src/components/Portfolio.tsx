    ...
    <section id="portfolio" className="relative py-28 md:py-40 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {PROJECTS.map((project, i) => (
            ...
            >
              ...
              />
              <div
                className="absolute bottom-6 left-6 w-2 h-2 rounded-full transition-all duration-500 opacity-0 group-hover:opacity-60"
                style={{ backgroundColor: colors[i] || "transparent" }}
              />
            </motion.div>
          ))}
        ...
        <motion.p
          ...
          className="text-center text-sm text-[#666] mt-14 font-light"
        >
