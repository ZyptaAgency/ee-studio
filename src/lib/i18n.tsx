...
const translations = {
  fr: {
    ...
    booking: {
      ...
      phone: "Téléphone",
      company: "Entreprise",
      message: "Votre message ou besoin",
      service: "Service",
      service_placeholder: "Sélectionnez un service",
      meeting_type: "Type de rendez-vous",
      type_call: "Appel",
      type_in_person: "Présentiel",
      call_hint: "Les appels sont disponibles en semaine uniquement.",
      date: "Date",
      date_placeholder: "Choisir une date",
      time: "Heure",
      optional: "facultatif",
      attachment: "Joindre un document (PDF)",
      attachment_hint: "PDF, 10 Mo max - brief, cahier des charges…",
      uploading: "Envoi du fichier…",
      confirm: "Envoyer ma demande",
      error: "Une erreur est survenue. Veuillez réessayer.",
      success: "Demande envoyée !",
      success_desc: "Vous allez recevoir un email de confirmation. Ajoutez le rendez-vous à votre calendrier :",
  ...
  en: {
    ...
    booking: {
      ...
      phone: "Phone",
      company: "Company",
      message: "Your message or need",
      service: "Service",
      service_placeholder: "Select a service",
      meeting_type: "Meeting type",
      type_call: "Call",
      type_in_person: "In person",
      call_hint: "Calls are available on weekdays only.",
      date: "Date",
      date_placeholder: "Choose a date",
      time: "Time",
      optional: "optional",
      attachment: "Attach a document (PDF)",
      attachment_hint: "PDF, 10 MB max - brief, specs…",
      uploading: "Uploading file…",
      confirm: "Send my request",
      error: "Something went wrong. Please try again.",
      success: "Request sent!",
      success_desc: "You will receive a confirmation email. Add the appointment to your calendar:",
      google: "Google Calendar",
      ical: "iCal / Apple",
    },
    footer: {
