...
const translations = {
  fr: {
    ...
    booking: {
      ...
      time: "Heure",
      optional: "facultatif",
      attachment: "Joindre un document",
      attachment_hint: "PDF, image, Word, Excel… - 15 Mo max",
  ...
  en: {
    ...
    booking: {
      ...
      time: "Time",
      optional: "optional",
      attachment: "Attach a document",
      attachment_hint: "PDF, image, Word, Excel… - 15 MB max",
